                ...
                for port_id, port in switch.ports_info.iteritems():
                    ...
                    for MAC, client in port.clients_info.iteritems():
                        ...
                        if client.IP == IP_address:
                            ...
                            data = {'Msg_Type':'Auth_OK_Resp', 'Msg_Content':'','IP_address':switch.infos.sock.getpeername()[0],'MAC':my_dpid_to_str(switch.infos.dpid),'user_MAC':MAC,'user_port':str(switch.infos.ports[client.switch_port].name)}
