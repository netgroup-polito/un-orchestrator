...
public:
	...
	GraphManager(int core_mask,list<string> physical_ports,string un_address,bool control,string un_interface,string ipsec_certificate, string vnf_repo_ip, int vnf_repo_port,string vnf_images_path);
	~GraphManager();
